...
function setup() {
  ...
  soundFile = createAudio(
    '../../music/LCIR_85_Bmin_Kit2_Pad_chorus.wav',
    afterload
  );
  soundFile2 = createAudio(
    '../../music/LCIR_85_Bmin_Kit2_Pad_intro.wav',
    afterload
  );
  soundFile3 = createAudio(
    '../../music/LCIR_85_Bmin_Kit2_Pad_verse.wav',
    afterload
  );
  soundFile4 = createAudio(
    '../../music/LCIR_90_Amaj_Kit7_Pad_02.wav',
    afterload
  );
